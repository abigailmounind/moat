...
const handleProduct=createProductService({repository:runtime.repository});
const server=http.createServer(async(req,res)=>{
 ...
 const allowed=route==='/frontend/index.html'||/^\/frontend\/src\/[a-z-]+\.(js|css)$/.test(route)||['/shared/growth-proof.js','/shared/understanding.js','/shared/profile.js','/shared/workspace.js','/shared/workspace-operations.js'].includes(route)||/^\/assets\/fonts\/[A-Za-z0-9._-]+\.(ttf|woff2?)$/.test(route)||['/assets/three-rivers/terrain-v1.png','/assets/three-rivers/rivers-v2.svg','/assets/three-rivers/rivers-watercolor-hires.svg','/assets/three-rivers/rivers-watercolor-hires-clean.svg','/assets/three-rivers/rivers-watercolor-hires-clean.png'].includes(route);
