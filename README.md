...
| `npm run check:postgres` | 真实数据库事务、并发、读取快照、关系变更、会话/回执及 Node 重启恢复 | 必须设置 MOAT_TEST_DATABASE_URL；创建随机测试 schema，结束后删除该 schema |
