...
export const rivers = [
  {id:'love',name:'热爱之河',short:'真正想做的事',icon:'heart',color:'#b87562',status:'持续探索中',capital:['心理资本','人力资本'],summary:'在写作与记录里，找到愿意持续投入的事。',unknown:'这份兴趣能否在长期实践中保持，仍值得慢慢探索。',label:[555,225],proofs:['writing'],directions:[]},
  {id:'survival',name:'生存之河',short:'赖以生存的事业',icon:'sprout',color:'#738564',status:'梳理现实支撑',capital:['人力资本','社会资本'],summary:'把项目中的协作与交付经验，放回当下的工作方向。',unknown:'财务空间和可持续投入条件尚未提供，保持未知。',label:[1080,250],proofs:['project'],directions:['research','collaboration']},
  {id:'ability',name:'能力之河',short:'可迁移的技能',icon:'mountain',color:'#77778d',status:'积累可迁移能力',capital:['人力资本','心理资本'],summary:'从一次研究与复盘中，看见可以迁移到新情境的能力。',unknown:'还需要在不同项目中验证，不能据此认定已经熟练。',label:[790,570],proofs:['review'],directions:['practice']}
];
export const proofs = [
...
export const directions = [
  {id:'research',river:'survival',name:'用户研究与洞察',support:'项目中的需求整理，提供了理解问题和组织信息的初步线索。',gap:'还缺少独立访谈、分析过程与实际交付的证明。',next:'围绕一个小问题完成一次访谈练习，再复盘提问方式。'},
  {id:'collaboration',river:'survival',name:'项目协作与推进',support:'小组项目的任务协调经验，是可以继续验证的支撑。',gap:'复杂情境下的协作、冲突处理和交付反馈仍待探索。',next:'选择一个小型协作项目，记录角色、贡献和伙伴反馈。'},
  {id:'practice',river:'ability',name:'研究与表达练习',support:'已有信息归类和复盘练习，可作为继续投入的起点。',gap:'尚缺跨情境的应用证据。',next:'将一份学习记录整理成可阅读的研究小结。'}
];
