...
const server=http.createServer(async(req,res)=>{
 ...
 const allowed=route==='/index.html'||/^\/src\/[a-z-]+\.(js|css)$/.test(route)||/^\/assets\/fonts\/[A-Za-z0-9._-]+\.(ttf|woff2?)$/.test(route)||['/assets/three-rivers/terrain-v1.png','/assets/three-rivers/rivers-v2.svg','/assets/three-rivers/rivers-watercolor-hires.svg'].includes(route);
